import { useUserNutzaps } from "@/hooks/useUserNutzaps";
...
import { DollarSign, Bitcoin, ArrowLeftRight, Zap } from "lucide-react";
import { Link } from "react-router-dom";
import { useState, useEffect, useRef } from "react";
import { useCurrencyDisplayStore } from "@/stores/currencyDisplayStore";
import { NostrEvent } from "@nostrify/nostrify";

interface UserNutzapListProps {
  userPubkey: string;
}

export function UserNutzapList({ userPubkey }: UserNutzapListProps) {
    ...
    return (
      <Card>
        <CardContent className="py-8 text-center text-muted-foreground">
          ...
          <p className="text-sm">No eCash sent to this user yet.</p>
